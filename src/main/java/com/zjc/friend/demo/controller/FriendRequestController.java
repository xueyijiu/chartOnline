...
import com.zjc.friend.demo.service.IFriendCategoryService;
...
public class FriendRequestController {
    ...
    @ResponseBody
    @Transactional
    public ResponseObject insertFriend(@RequestParam Long userId, @RequestParam(required = false) Long catId,
        ...
        if (StringUtils.isNotBlank(friendComment)) {
            friendRequest.setFriendComment(friendComment);
        }
...
//        }
        ...
        return new ModelAndView("html/friendAdd", "user", model);
    }
...
//        wrapper.eq("user_id",userInfo.getId());
        ...
        return new ModelAndView("html/friend", "info", model);
    }
    ...
    @ResponseBody
    public ResponseObject updateApplyFriend(Long id, Integer status, @RequestParam(required = false) Long catId) {
        Userinfo userInfo = CurrentUser.getUserInfo(userService);
